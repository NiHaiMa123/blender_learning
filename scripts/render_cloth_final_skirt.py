...
target = Vector((1.0, -7.0, 0.52))
old_cam = scene.camera
cam_data = bpy.data.cameras.new('CLOTH_REBUILD_FINAL_SKIRT_DATA')
cam = bpy.data.objects.new('CLOTH_REBUILD_FINAL_SKIRT', cam_data)
scene.collection.objects.link(cam)
cam.location = (2.9, -10.8, 0.72)
...
for frame, tag in [(1, 'f001'), (80, 'f080'), (120, 'f120')]:
    ...
    scene.render.filepath = r'D:\project\blender_learning\renders\cloth_final_skirt_%s.png' % tag
...
scene.frame_set(120)
print('FINAL_SKIRT_RENDER|frames=1,80,120')
