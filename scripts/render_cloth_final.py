...
cam_data = bpy.data.cameras.new('CLOTH_REBUILD_FINAL_CAMERA_DATA')
cam = bpy.data.objects.new('CLOTH_REBUILD_FINAL_CAMERA', cam_data)
...
for frame, tag in [(1, 'f001'), (80, 'f080'), (120, 'f120')]:
    ...
    scene.render.filepath = r'D:\project\blender_learning\renders\cloth_final_%s.png' % tag
...
scene.frame_set(120)
print('FINAL_RENDER|frames=1,80,120')
