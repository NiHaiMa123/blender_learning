"""Phase 19: iteration 5 — smooth root tips (no spikes), finer bark on limbs."""
...
if not bark_fine:
    ...
    for n in bark_fine.node_tree.nodes:
        if n.bl_idname == 'ShaderNodeBump':
            ...
            n.inputs['Distance'].default_value *= 0.5
        if n.bl_idname == 'ShaderNodeBrightContrast':
            n.inputs['Brightness'].default_value += 0.06
tree_col = col('TREE')
...
s.render.filepath = os.path.join(RENDER_DIR, 'p19_mid.png')
