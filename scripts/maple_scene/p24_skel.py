"""Phase 24: polish — remove apex hook (trunk flows into co-leader), longer
second-order branches so they read as limbs not thorns. Mid-only render."""
...
limb('trunk', [
    ...
    ((-5.35, 0.10,  5.7), 0.78),   # keeps flowing up-left, no hook
    ((-5.10, 0.05,  6.6), 0.62),
...
second_order = [
    ('sA1', (-5.55, 0.15, 7.35), (-6.13, -1.16, 8.22), 0.15, 0.04),
    ('sA2', (-6.40, 0.30, 8.05), (-7.34, -0.93, 8.63), 0.12, 0.03),
    ('sA3', (-5.55, 0.15, 7.35), (-4.75, 1.31, 8.44), 0.14, 0.04),
    ('sB1', (-3.20, 0.10, 6.60), (-3.56, -1.28, 7.40), 0.16, 0.05),
    ('sB2', (-1.30, 0.20, 6.85), (-1.66, -1.18, 7.79), 0.14, 0.04),
    ('sB3', (1.20, 0.30, 7.05), (0.84, 1.53, 8.06), 0.13, 0.04),
    ('sB4', (3.90, 0.40, 7.10), (4.63, -0.69, 7.75), 0.11, 0.03),
    ('sB5', (-3.20, 0.10, 6.60), (-2.33, 1.33, 7.40), 0.15, 0.04),
    ('sB6', (0.10, 0.28, 6.90), (0.54, -0.92, 7.77), 0.12, 0.03),
    ('sC1', (-4.20, -0.25, 7.30), (-5.07, -1.12, 8.17), 0.13, 0.04),
    ('sC2', (-3.75, -0.35, 8.10), (-4.40, -0.06, 9.19), 0.1, 0.03),
    ('sD1', (-3.90, -0.55, 5.25), (-4.19, -1.85, 6.05), 0.1, 0.03),
    ('sE1', (-4.35, 0.85, 6.95), (-5.22, 1.72, 7.60), 0.1, 0.03),
    ('sE2', (-3.90, 1.55, 7.70), (-4.77, 2.56, 8.21), 0.08, 0.02),
    ('sF1', (-5.90, -0.60, 5.60), (-6.91, -0.24, 6.40), 0.08, 0.02),
]
...
s.render.filepath = os.path.join(RENDER_DIR, 'p24_mid.png')
