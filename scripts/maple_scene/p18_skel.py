"""Phase 18: iteration 4 — untwist rope look (trunk 100deg, limbs ~half), blunter tips, slower mid-taper."""
...
for i, ang in enumerate((-0.7, 0.4, 2.5, 3.7)):
    ...
    ], deep_star, twist_total=math.radians(45))
...
limb('limbA', [
    ...
    ((-6.60, 0.40, 8.5), 0.18),
    ((-7.50, 0.45, 9.2), 0.09),
], soft_star, twist_total=math.radians(35))
# A2: sub-branch off A going up
limb('limbA2', [
    ((-5.65, 0.30, 7.7), 0.16),
    ((-5.40, 0.85, 8.45), 0.11),
    ((-5.15, 1.25, 9.15), 0.05),
], soft_star, twist_total=math.radians(30))
...
limb('limbB', [
    ...
    ((4.10, 0.40, 7.25), 0.20),
    ((6.40, 0.45, 7.10), 0.09),
], soft_star, twist_total=math.radians(80))
...
limb('limbB2', [
    ...
    ((3.20, 1.00, 8.40), 0.11),
    ((4.40, 1.10, 9.00), 0.05),
], soft_star, twist_total=math.radians(45))
...
s.render.filepath = os.path.join(RENDER_DIR, 'p18_mid.png')
