"""Phase 16: iteration 2 — open the S (broader arcs, less corkscrew), slower
branch taper, second-order branches along limbs, halved collars. Mid-only render."""
...
s.render.filepath = os.path.join(RENDER_DIR, 'p16_mid.png')
bpy.ops.render.render(write_still=True)
print('RENDERED p16_mid')
