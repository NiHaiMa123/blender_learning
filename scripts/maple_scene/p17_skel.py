"""Phase 17: iteration 3 — dense secondary branches along every limb, softer
apex hook, irregular hollow. Mid-only render."""
...
limb('trunk', [
    ...
    ((-4.35, 0.10, 5.6), 0.64),
    ((-3.80, 0.05, 6.2), 0.52),
], deep_star, twist_total=math.radians(180))
...
second_order = [
    ...
    ('sA2', (-5.65, 0.30, 7.7), (-6.35, -0.55, 8.1), 0.12, 0.03),
    ...
    ('sB4', (4.10, 0.40, 7.25), (4.55, -0.35, 7.75), 0.11, 0.03),
    ('sB5', (-2.10, 0.10, 6.30), (-1.55, 0.95, 6.95), 0.15, 0.04),
    ('sB6', (0.60, 0.28, 6.95), (0.85, -0.55, 7.6), 0.12, 0.03),
    ('sC1', (-3.30, -0.25, 6.85), (-3.95, -0.85, 7.5), 0.13, 0.04),
    ('sC2', (-3.00, -0.35, 7.75), (-3.55, -0.20, 8.5), 0.10, 0.03),
    ('sD1', (-3.10, -0.55, 5.10), (-3.35, -1.45, 5.65), 0.10, 0.03),
    ('sE1', (-3.45, 0.85, 6.55), (-4.15, 1.45, 7.05), 0.10, 0.03),
    ('sE2', (-3.05, 1.55, 7.35), (-3.75, 2.25, 7.75), 0.08, 0.02),
    ('sF1', (-5.55, -0.60, 5.55), (-6.25, -0.35, 6.1), 0.08, 0.02),
]
...
for name, a, b in twig_specs:
    ...
    limb(name, [(a, 0.06), (mid, 0.038), (b, 0.015)], soft_star,
         twist_total=math.radians(50))
...
s.render.filepath = os.path.join(RENDER_DIR, 'p17_mid.png')
