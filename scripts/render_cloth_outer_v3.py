...
cam_data = bpy.data.cameras.new('CLOTH_REBUILD_OUTER_CAMERA_DATA')
cam = bpy.data.objects.new('CLOTH_REBUILD_OUTER_CAMERA', cam_data)
...
for f, tag in [(1, 'f001'), (80, 'f080')]:
    scene.frame_set(f)
    scene.render.filepath = r'D:\project\blender_learning\renders\cloth_outer_v3_%s.png' % tag
